(Start End Rules S_right T2_right T3_right) -> (Start End Rules S_right T2_right T3_right)
with (Q Q1 Q2 S1 S2 S3 S4 S5 S6 S S_left RulesRev Rule)
...
act1: fi !RulesRev && Q = Start from init else act4
      ((Q1 . (S1 . (S2 . (S3 . (S4 . (S5 . (S6 . Q2))))))) . Rules) <- Rules
...
act3: fi Q = Q2 && S1 = 'SLASH from move1 else act2
      RulesRev <- ((Q1 . (S1 . (S2 . (S3 . (S4 . (S5 . (S6 . Q2))))))) . RulesRev)
