...
left_1b_t1: from left_t1 // MERGE? 1
         S_t1 ^= 'BLANK
         goto left1_t1
...
left_2b_t1: from left1_t1 // MERGE? 2
         S_t1 ^= 'BLANK
         goto left2_t1
...
right_2b_t1: from right1_t1 // MERGE? 2
          S_t1 ^= 'BLANK
          goto right2_t1
...
left_1b_t2: from left_t2 // MERGE? 1
         S_t2 ^= 'BLANK
         goto left1_t2
...
left_2b_t2: from left1_t2 // MERGE? 2
         S_t2 ^= 'BLANK
         goto left2_t2
...
right_2b_t2: from right1_t2 // MERGE? 2
          S_t2 ^= 'BLANK
          goto right2_t2
...
left_1b_t3: from left_t3 // MERGE? 1
         S_t3 ^= 'BLANK
         goto left1_t3
...
left_2b_t3: from left1_t3 // MERGE? 2
         S_t3 ^= 'BLANK
         goto left2_t3
...
right_2b_t3: from right1_t3 // MERGE? 2
          S_t3 ^= 'BLANK
          goto right2_t3
