...
act3:
	...
	if ((((Q = Q2) && (S1_t1 = 'SLASH)) && (S1_t2 = 'SLASH)) && (S1_t3 = 'SLASH))
		goto move1
		else act2
...
left2_t1:
	from move_t1_left_or_other
	if ((S_left_t1 = 'nil) && (S_t1 = 'BLANK))
		goto left_2b_t1
		else left_2p_t1

move_t1_left_or_other:
	from move_t2
	goto left2_t1
...
left2_t2:
	from move_t2_left_or_other
	if ((S_left_t2 = 'nil) && (S_t2 = 'BLANK))
		goto left_2b_t2
		else left_2p_t2

move_t2_left_or_other:
	from move_t3
	goto left2_t2
...
left2_t3:
	from move_t3_left_or_other
	if ((S_left_t3 = 'nil) && (S_t3 = 'BLANK))
		goto left_2b_t3
		else left_2p_t3

move_t3_left_or_other:
	from move1
	goto left2_t3
